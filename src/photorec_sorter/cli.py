...
def main_cli():
    ...
    sort_photorec_folder(source=args.source, destination=args.destination, max_files_per_folder=args.max_per_dir,
                    enable_split_months=args.split_months, enable_keep_filename=args.keep_filename,
                    enable_datetime_filename=args.enable_datetime_filename, min_event_delta_days=args.min_event_delta)
